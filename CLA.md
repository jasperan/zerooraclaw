# ZeroOraClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to ZeroOraClaw. This agreement
protects both contributors and users of the ZeroOraClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the ZeroOraClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to ZeroOraClaw
  for inclusion in the ZeroOraClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"ZeroOraClaw"** means the maintainers and organization responsible
  for the ZeroOraClaw project at https://github.com/jasperan/zerooraclaw.

---

## 2. Grant of Copyright License

You grant ZeroOraClaw and recipients of software distributed by ZeroClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with ZeroOraClaw.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the ZeroOraClaw name,
...
ZeroOraClaw will maintain attribution to contributors in the repository
...
All Contributions accepted into the ZeroOraClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the ZeroOraClaw repository,
...
https://github.com/jasperan/zerooraclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the ZeroOraClaw dual-license model.*
