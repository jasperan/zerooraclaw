...
# For 64-bit (aarch64):
curl -LO https://github.com/jasperan/zerooraclaw/releases/latest/download/zeroclaw-aarch64-linux-android.tar.gz
tar xzf zeroclaw-aarch64-linux-android.tar.gz

# For 32-bit (armv7):
curl -LO https://github.com/jasperan/zerooraclaw/releases/latest/download/zeroclaw-armv7-linux-androideabi.tar.gz
