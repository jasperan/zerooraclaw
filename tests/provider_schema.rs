...
use zerooraclaw::providers::compatible::AuthStyle;
use zerooraclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use zerooraclaw::providers::compatible::OpenAiCompatibleProvider;
